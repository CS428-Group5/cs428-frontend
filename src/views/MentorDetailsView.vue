    ...
    <section class="grid grid-cols-12 gap-x-6">
        ...
        <div class="col-span-9 flex flex-col p-2">
            ...
            <div class="mt-5 flex flex-row">
                ...
                <button class="w-9 h-9 text-black rounded-xl" style="background-color: #D9E6FA;">+</button>
                <small class="ml-3 my-auto">Number of sessions left: {{ sampleMentor.remainingSession }}</small>
            </div>
            <div class="mt-5 flex flex-row space-x-13">
                <button class="w-fill h-10 px-3 mr-3 text-white rounded-xl" style="background-color: #599BFF;">
                    <span>Book a session</span>
                </button>
                <button class="w-fill h-10 px-3 mr-3 text-blue-dark border border-blue-dark rounded-xl" style="background-color: #FFFFFF;">
    ...
    <section class="grid grid-cols-12 gap-x-6">
        <div class="col-span-6 flex flex-col p-2">
            ...
            <div>
                ...
                <p>Lorem ipsum, dolor sit amet consectetur adipisicing elit. Facilis perspiciatis a, velit tenetur ab distinctio optio earum quae atque maiores, dolor fugiat eligendi laudantium? Repellendus ullam temporibus eaque asperiores quaerat.</p> 
            </div>
        </div>
        ...
        <div class="col-span-6 flex flex-col p-2">
            ...
            <div>
                ...
                <span class="flex flex-row mt-5">
                    ...
                    <div class="flex flex-col" v-for="i in 4">
                        <button class="w-9 h-9 ml-3 px-1 text-blue-dark border border-blue-dark rounded-xl" style="background-color: #FFFFFF;">
                            {{ i }}
                        </button>
                    </div>
            ...
            <div class="mt-3">
                <h3>Rating: <span class="font-bold">{{ averageRating }}/5</span></h3>
                <div class="my-3" v-for="(review, index) in reviews">
...
const reviews = [
    {
        ...
        comment: 'Lorem ipsum dolor sit amet consectetur adipisicing elit. Corrupti excepturi corporis, hic voluptatem qui ullam, repellat ipsum suscipit veritatis accusamus libero aut unde animi dolor aperiam accusantium vitae deserunt quae.', 
        score: 5},
    {
        author: 'Jacob Jones', 
        comment: 'Lorem ipsum dolor sit amet consectetur adipisicing elit. Corrupti excepturi corporis, hic voluptatem qui ullam, repellat ipsum suscipit veritatis accusamus libero aut unde animi dolor aperiam accusantium vitae deserunt quae.', 
