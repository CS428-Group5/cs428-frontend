    ...
    <div class=" col-span-1 flex flex-col">
        ...
        <form @submit.prevent="loginAccount">
            ...
            <input id="email" name='email' v-model="form.email"
                class="bg-gray-lightest rounded-xl w-full px-6 py-4 mb-4 text-base" placeholder="xyz@email.com" />

            <label for="password" class="text-sm">Password</label>
            <input id="password" name='password' v-model="form.password" type="password"
                class="bg-gray-lightest rounded-xl w-full px-6 py-4 mb-4 text-base" placeholder="••••••••" />
