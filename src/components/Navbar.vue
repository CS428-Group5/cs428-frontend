<template>
    <div class="grid grid-cols-12 gap-x-6 pt-3 pb-8">
        ...
        <div v-else class="col-span-3 flex justify-end items-center gap-6 relative">
            ...
            <img class="h-11 w-11 aspect-square rounded-3xl" src="@/assets/avatar.jpg" alt="avatar" />
            <div class="z-10 absolute top-14 right-0 bg-white divide-y divide-gray-100 rounded-lg shadow ">
                <ul v-if="!isMentor">
